...
# the url above shows what looks like one table, but it is actually two tables close together.
# first, grab the title of the team columns and the teams from that first table
# then, grab the stat columns and rows from the second table
...
def get_stats(url, headers):
    ...
    # this is the header of the first table with teams
    team_column_header = soup.find("thead").text
    #looking for both the tables 
...
# <th title="" class="Table__TH"><span class="underline" title="Games Played"><a class="AnchorLink clr-gray-01" tabindex="0" href="/nfl/stats/team/_/view/offense/season/2025/seasontype/2/stat/rushing/table/general/sort/gamesPlayed/dir/desc">GP</a></span></th>
